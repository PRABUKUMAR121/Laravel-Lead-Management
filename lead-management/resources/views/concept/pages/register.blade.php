...
<!-- Mirrored from themewagon.github.io/concept/pages/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Dec 2025 05:01:22 GMT -->
...
<body>
    ...
    <!-- signup form  -->
    <!-- ============================================================== -->
    <form class="splash-container" action="{{url('/register')}}" method='post'>
        <div class="card">
