...
<!-- Mirrored from themewagon.github.io/concept/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Dec 2025 05:01:04 GMT -->
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <h2 class="pageheader-title">@yield('page_subtitle','E-commerce Dashboard Template') </h2>

                                <p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link"> @yield('menu','Dashboard')</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">@yield('page','E-Commerce Dashboard Template')</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
...
<!-- Mirrored from themewagon.github.io/concept/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Dec 2025 05:01:07 GMT -->
</html>